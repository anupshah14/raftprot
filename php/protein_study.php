...
$id=$_POST["uniprot"];
	...
	$query=mysql_query("select distinct idStudy, firstAuthor,year,pubMedLink, Title from study inner join experiment_new on study.idStudy=experiment_new.Study_idStudy inner join protein_new on experiment_new.idExperiment=protein_new.Experiment_idExperiment where protein_new.accession='$id' group by idStudy") or die (mysql_error());
