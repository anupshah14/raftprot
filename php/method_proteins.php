...
//echo $detergent;
	...
	$method="DRM";
		$query=mysql_query("select protein_new.accession,count(protein_new.accession) as protein_no, protein_new.protein_name, protein_new.gene_name,high_confidence.lable from protein_new
								...
								where experiment_new.idExperiment in (select experiment_new.idExperiment from experiment_new where experiment_new.biochemMethod='$method' and experiment_new.detergent='$detergent') group by protein_new.accession") or die (mysql_error());
	...
	$query=mysql_query("select protein_new.accession,count(protein_new.accession) as protein_no, protein_new.protein_name, protein_new.gene_name,high_confidence.lable from protein_new
								inner join experiment_new on experiment_new.idExperiment=protein_new.Experiment_idExperiment 
								left join high_confidence on protein_new.accession=high_confidence.accession
								where experiment_new.idExperiment in (select experiment_new.idExperiment from experiment_new where experiment_new.biochemMethod='$method') group by protein_new.accession") or die (mysql_error());
